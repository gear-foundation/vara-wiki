...
Applications that use delayed messages in their business logic and their source code are shown in the [Program Examples](/examples) section. These include applications such as: [Game Battle](/examples/Gaming/battle), [VaraTube](/examples/Infra/varatube), [Dynamic NFT](/examples/NFTs/dynamic-nft).
