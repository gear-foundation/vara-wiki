...
Gear Protocol, built on [Substrate](/docs/about/technology/substrate), facilitates swift dApp development. It is the most developer-friendly way to implement programs and smart contracts with arbitrary logic and of any complexity.
...
Anyone with a standard computer can run a [Gear node](/docs/node) today and always.
