...
For most users, popular and reliable wallets will suffice. For creating a cold wallet for storing funds, consider using [Ledger](/docs/account/ledger) or [Polkadot Vault](/docs/account/polkadot-vault) (formerly Parity Signer).
...
> Yes! Vara currently supports [Ledger](/docs/account/ledger) and [Polkadot Vault](/docs/account/polkadot-vault).
