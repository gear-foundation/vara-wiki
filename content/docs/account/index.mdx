...
For most users, popular and reliable wallets will suffice. For creating a cold wallet for storing funds, consider using [Ledger](ledger) or [Polkadot Vault](polkadot-vault) (formerly Parity Signer).
...
> Yes! Vara currently supports [Ledger](ledger) and [Polkadot Vault](polkadot-vault).
