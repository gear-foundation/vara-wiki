...
|------|------|
| ![Vara Template Home Page](/images/docs/api/tooling/cva.png) | ![Vara Template Wallet Connection](/images/docs/api/tooling/cva-wallet.png) |
| ![Gear Template Home Page](/images/docs/api/tooling/cga.png) | ![Gear Template Wallet Connection](/images/docs/api/tooling/cga-wallet.png) |
