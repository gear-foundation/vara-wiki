...
An example of using vouchers is shown in the [Battleship](docs/examples/Gaming/Battleship/battleship) game. Users without tokens on their balance can make moves by sending messages to a program using a voucher.
