---
custom_title: Vara ↔ Ethereum Bridge Technical Overview
...
<Callout type="warning" title="To explore the code navigate to:">
...
<Callout type="note" title="Example Transaction Flow">
...
<Callout type="info" title="Bridging Payment Contracts">
...
<Callout type="info" title="What happens if relayers go offline?">
...
<Callout type="note" title="What Does This Means for Users?">
