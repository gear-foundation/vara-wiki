...
<Callout type="info" title="Developer Example:">
...
<Callout type="note" title="Want to learn more about Gear.exe?">
...
<Callout type="note" title="Curious how the Vara-Ethereum Bridge works?">
