...
<Callout type="info" title="To submit code, use the [Gear IDEA](https://idea.gear-tech.io/) application or submit it via the @gear-js/api library. The `Gear Program` CLI can also be used - https://github.com/gear-tech/gear/tree/master/gcli.">
