...
<Callout type="info" title="[`ActorId`](https://docs.rs/gstd/latest/gstd/struct.ActorId.html) is a special type that represents an 32 bytes array and defines any `ID` in Gear Protocol.">
