...
For a quick overview of writing and running programs on Vara, refer to [this guide](/docs/getting-started-in-5-minutes). It walks through writing a program, compiling it to Wasm, and deploying it to the Vara Network within just 5 minutes.
...
For detailed instructions on installing and running the Vara Node, as well as keeping it operational, backing up, restoring, and troubleshooting, refer to the guide [here](/docs/node).
