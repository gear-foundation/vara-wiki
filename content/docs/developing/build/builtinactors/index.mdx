...
<Callout type="note" title="Understanding Built-in Actors">
    **Built-in Actors** are part of the runtime and can only be added by the developers of the Gear Protocol.

    * **Restrictions:** They cannot be created by other programs or initiated by users.
    * **Access:** Despite their special status, they are accessible to everyone through the standard messaging system, just like any other program.
</Callout>
