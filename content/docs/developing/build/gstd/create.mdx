...
custom_title: Create a Program from a Program
---
...
<Callout type="info" title="Tools for Code Submission">
    To submit your code to the network, you can use:

    * **Web UI:** The [Gear IDEA](https://idea.gear-tech.io/) application.
    * **Library:** The [@gear-js/api](https://github.com/gear-tech/gear-js/tree/main/apis/gear#readme) library for automated interactions.
    * **CLI:** The [Gear Program CLI (gcli)](https://github.com/gear-tech/gear/tree/master/gcli) for command-line fans.
</Callout>
