---
title: Gas Reservation
---

Gas reservation is a powerful feature of the Gear Protocol that enables a new approach to programming and modern [use cases](/docs/about/features/message-automation).
...
One of the key advantages of this feature is the ability to send [messages delayed](/docs/developing/build/gstd/delayed-messages) in time automatically to any actor in the network, whether it is a user, another program, or even **itself**. In fact, a program can execute itself **an unlimited** number of blocks, provided that enough gas for execution is kept available.
