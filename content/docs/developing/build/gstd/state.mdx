...
<Callout type="info" title="What is ActorId?">
    [`ActorId`](https://docs.rs/gstd/latest/gstd/struct.ActorId.html) is a fundamental type in Gear Protocol.

    It represents a **32-byte array** and is used to define any unique identifier within the network (e.g., users, programs, or contracts).
</Callout>
...
[Learn more](/docs/developing/build/gstd/metadata) how metadata works.
