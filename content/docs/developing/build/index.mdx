...
custom_title: Developing Programs
---
...
For a quick overview of writing and running programs on Vara, refer to [this guide](/docs/vara-network/getting-started-in-5-minutes). It walks through writing a program, compiling it to Wasm, and deploying it to the Vara Network within just 5 minutes.
