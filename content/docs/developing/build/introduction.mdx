...
You can find the minimal example in the [Getting Started](/docs/vara-network/quick-start) section. It is a simple program that stores the counter, can increment and decrement it and returns the current value of the counter.
