---
title: Testing with gclient
custom_title: Testing with `gclient`
---
...
Open the second terminal window and run tests using `cargo` as described in the [previous section](/docs/developing/build/testing#building-a-program-in-test-mode).

## Simple Example

Add an end-to-end test to the `first-gear-app` introduced in the [Getting Started](/docs/vara-network/getting-started-in-5-minutes#creating-your-first-vara-program) section.
