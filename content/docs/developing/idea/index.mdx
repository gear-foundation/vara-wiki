...
The Gear IDEA portal is a convenient tool designed to familiarize users with the Gear platform. It offers program and smart contract developers the easiest and fastest way to work with their programs on Vara Network directly in their browser without additional configuration.
...
Microservice distributes the one-time 100 VARA developer grant.
