...
Use the `Network Switcher` to select Vara Mainnet (selected by default). The portal can also connect to your locally launched developer node. 

![Idea switch network](/images/docs/idea/switch-network.jpg)

## Programs

The `Programs` view is the default view of the Idea portal. The list of programs is displayed as tiles where you can instantly perform basic operations: send a message to a program, read its state, or issue a [voucher](/docs/developing/api/vouchers) for a specified account(s) to enable interaction with the program without worrying about gas fees.
...
![Idea main screen](/images/docs/idea/idea_main.jpg)
...
![Idea Codes](/images/docs/idea/codes.jpg)
...
![Idea Messages](/images/docs/idea/messages.jpg)
...
![Idea Explorer](/images/docs/idea/explorer.jpg)

### Mailbox

[`Mailbox`](/docs/developing/build/gstd/mailbox) contains messages sent from programs to the currently connected account.
...
![Idea Vouchers](/images/docs/idea/vouchers.jpg)
