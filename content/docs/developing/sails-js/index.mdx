...
- **Quick Start with Generated Client Library**
  ...
  If you prefer a faster setup and a straightforward way to interact with your application, the generated client library is an excellent starting point. It abstracts away many complexities, making it ideal for developers who want to focus on application logic. See the [Client Generation](/docs/developing/sails-js/client-generation) section for guidance on using the `sails-js-cli` tool and integrating the generated `lib.ts` into your project.
