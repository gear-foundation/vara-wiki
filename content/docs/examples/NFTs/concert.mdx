...
### Init Config
To successfully initialize a concert program, one should provide an ActorID of the [Vara Miltiple Token Standard (VMT)](/docs/examples/Standards/vmt) program to hold all the token manipulations.
