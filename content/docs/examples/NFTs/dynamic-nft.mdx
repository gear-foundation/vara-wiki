...
<Callout type="tip">
The project code is developed using the [Sails](/docs/build/sails) framework.
</Callout>

<Callout type="note">
This contract is an extended version of the standard [vNFT](/docs/examples/Standards/vnft). This article focuses solely on the additional features and fields that differentiate it from the basic implementation.
</Callout>
