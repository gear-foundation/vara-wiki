...
This guide explains how to create a `React` application and connect it to an [extended NFT smart contract](/docs/examples/Standards/vnft#extended-vnft-implementation) running in the blockchain.
