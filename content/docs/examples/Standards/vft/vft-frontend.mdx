...
[See VFT Standard description](/docs/examples/Standards/vft)
...
Use the official Vara React app [template](/docs/api/tooling/create-gear-app).
...
Follow the client generation instructions: [Client Generation Docs](/docs/sails-js/client-generation)
...
<Callout type="info" title="Additional Resources">
    ...
    * [React Sails Hooks Documentation](/docs/sails-js/react-hooks)
...
<Callout type="note" title="API Reference">
    For a full list of query methods and detailed usage, see the [React Hooks API Reference](/docs/sails-js/react-hooks).
</Callout>
