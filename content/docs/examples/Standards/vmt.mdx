...
<Callout type="note" title="This extended VMT service demonstrates how the core functionality can be built upon to include features like minting, burning, and URI management. The complete implementation is available on [GitHub](https://github.com/gear-foundation/standards/tree/master/extended-vmt).">
