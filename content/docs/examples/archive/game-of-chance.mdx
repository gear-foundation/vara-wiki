...
<Callout type="note">
    For a more detailed technical description, see its [documentation on the dApps documentation portal](https://dapps.gear.rs/game_of_chance) and [the source code section](/docs/examples/archive/game-of-chance#source-code).
</Callout>
