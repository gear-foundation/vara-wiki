...
- Potential integration with other Substrate-based networks. Substrate framework simplifies the creation of custom blockchains for specific applications. Substrate provides extensive functionality out-of-the-box and allows one to focus on creating a custom engine on top of the protocol. The majority of developers and inspirers of the Gear Protocol were directly involved in creating the Substrate technology. 
