...
Download or compile the `gear` executable file for the operating system. [See more](/docs/node#install-with-pre-built-binary)
...
<Callout type="error" title="Irreversible Action">
    ...
    Before proceeding, ensure you have followed the [Backup and Restore](/docs/node/backup-restore) instructions to save your important data.
</Callout>
