...
Please refer to the [System Requirements](/docs/node#system-requirements) to see the actual hardware requirements.
...
Validator nodes in [Vara](https://vara.network/), are incentivized according to the Nominated Proof-of-Stake (NPoS) mechanism. Refer to [this article](/docs/staking) for more details.
