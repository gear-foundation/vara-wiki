...
<Callout type="note">
The minimum amount of VARA required to start nominating validators directly and earning rewards is 50 VARA. This is the minimum balance needed to qualify for rewards. If your balance is less than 50 VARA, consider joining [Nomination Pools](/docs/staking/nominate#join-nomination-pools).
</Callout>
