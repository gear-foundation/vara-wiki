...
<Callout type="info" title="Add `--telemetry-url &quot;wss://telemetry.rs/submit 1&quot;` to the node startup parameter, then your node will show up on the telemetry dashboard.">
</Callout>
