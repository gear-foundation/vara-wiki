...
<Callout type="tip" title="Prefer a visual interface?">
  Use **[Vara.eth IDEA](https://idea-eth.vara.network)** — deploy, fund, initialize and send messages to programs directly in the browser without any CLI setup. → [IDEA Guide](/docs/vara-eth/setup/idea)
</Callout>
...
- **[Vara.eth IDEA](https://idea-eth.vara.network)** — send messages, read state and view activity directly in the browser. No setup needed. → [IDEA Guide](/docs/vara-eth/setup/idea)
