...
Before deploying on-chain, test your programs locally. This page covers unit testing, integration testing patterns, and common debugging techniques.
...
mod tests {
    ...
    #[test]
    fn test_increment() {
        let mut service = CounterService.expose(0);
...
```
Edit code → cargo test → cargo build --release → Deploy to your node → Test via CLI/SDK
```
