...
Uploading code costs standard Ethereum gas for the transaction, plus the EIP-4844 blob fee. On testnet, use Hoodi ETH (see [Wallet Setup](/docs/vara-eth/setup/wallet-setup)). On mainnet, standard Ethereum gas fees apply.
