...
Open your program on [idea-eth.vara.network](https://idea-eth.vara.network) — attach an IDL and use the **READ** tab to call read-only methods visually. The activity feed shows all incoming and outgoing messages in real time. → [IDEA Guide](/docs/vara-eth/setup/idea)
