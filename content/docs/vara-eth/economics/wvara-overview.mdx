...
**Contract address (Ethereum Mainnet)**: [`0xB67010F2246814e5c39593ac23A925D9e9d7E5aD`](https://etherscan.io/address/0xB67010F2246814e5c39593ac23A925D9e9d7E5aD)
...
The testnet faucet is currently offline between campaign phases. On a [full local stack](/docs/vara-eth/setup/local-node), the WVARA contract is deployed with your Router and you control the supply.

### Mainnet

wVARA is available via:
