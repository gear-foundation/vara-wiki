...
The campaign faucet is no longer running. On a [full local stack](/docs/vara-eth/setup/local-node), the WVARA contract is deployed with your Router and you control the supply.
