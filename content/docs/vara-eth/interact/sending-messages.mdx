...
[Vara.eth IDEA](https://idea-eth.vara.network) provides a visual interface for sending messages — no code required. Open your program, attach an IDL, and call methods from the **WRITE** tab directly in the browser. → [IDEA Guide](/docs/vara-eth/setup/idea)
