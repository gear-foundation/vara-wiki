...
|---|---|---|
| **Router** | `0xE549b0AfEdA978271FF7E712232B9F7f39A0b060` | Core settlement contract. Manages code validation, program creation, and batch commitments. |
...
| **wVARA** | `0xE1ab85A8B4d5d5B6af0bbD0203EB322DF33d0464` | ERC-20 wrapped VARA token. |
