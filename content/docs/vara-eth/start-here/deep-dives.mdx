...
| ------------------------ | -------------- | --------------------------------------------------------------- |
| **PoA (current phase)**  | Proven in MainNet & TestNet campaigns | Controlled validator set operated by the protocol team          |
...
| [One of Us](https://github.com/gear-foundation/one-of-us) | Full reference application from the completed launch campaign — demonstrated instant UI on Ethereum, with 931 members joining ([campaign recap on X](https://x.com/VaraNetwork/status/2016895724873777269)) |
| [Robo Miner](https://github.com/gear-foundation/robo-miner) | Campaign reference stack for a live agent arena — a Phaser mining game backed by Vara.eth programs (world, proxy, RES rewards, redeem) with a leaderboard and an Agent Skill Pack so AI agents can play ([campaign announcement on X](https://x.com/VaraNetwork/status/2079896261478818255)) |
