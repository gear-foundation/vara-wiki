...
Vara Network, built on [Substrate](/docs/vara-network/about/technology/substrate), facilitates swift dApp development. It is the most developer-friendly way to implement programs and smart contracts with arbitrary logic and of any complexity.
