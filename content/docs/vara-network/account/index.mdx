...
For most users, popular and reliable wallets will suffice. For creating a cold wallet for storing funds, consider using [Ledger](/docs/vara-network/account/ledger) or [Polkadot Vault](/docs/vara-network/account/polkadot-vault) (formerly Parity Signer).
...
![img alt](/images/docs/account/subwallet-1.png)

4. Create a master password and click `Continue`.

<Callout type="note">
  SubWallet cannot help restore the password once it is lost as the wallet is non-custodial. Recover the account using
  the seed if the master password is forgotten.
</Callout>

![img alt](/images/docs/account/subwallet-2.png)
...
![img alt](/images/docs/account/subwallet-3.png)

6. The wallet has been successfully created!

![img alt](/images/docs/account/subwallet-4.png)
...
![img alt](/images/docs/account/talisman-1.png)

4. Enter a strong password:

![img alt](/images/docs/account/talisman-2.png)

And that's it. The wallet has been created:

![img alt](/images/docs/account/talisman-3.png)

<Callout type="warn" title="Backup Your Seed Phrase">
    Don't forget to save your seed phrase by clicking the **Backup Now** button.

    **Caution:** If you lose this phrase, you may lose access to your funds forever. If you skip this now, you can find the backup option later in **Settings**.
...
![img alt](/images/docs/account/create-account-3.png)

<Callout type="note" title="Account Password Usage">
    The password you choose encrypts your account information and is **stored locally** in your browser extension.

    You will need to re-enter it to:
    * Process any **outgoing transactions**.
...
[![img alt](/images/docs/account/subwallet-logo2.png)](https://subwallet.app/)

[![img alt](/images/docs/account/nova-logo.png)](https://novawallet.io/)

## Via Telegram

Vara Wallet is available as a Telegram bot, allowing you to manage your Vara account directly within the Telegram app — no browser extension or mobile install required.

<img src="/images/docs/account/varan-wallet-telegram.png" alt="Varan Wallet — Your Crypto Here" style={{maxHeight: '200px'}} />

Try it now on Telegram: [@varanwalletbot](https://t.me/varanwalletbot)
...
<img
  src="/images/docs/account/varan-wallet-telegram.png"
  alt="Varan Wallet — Your Crypto Here"
...
> The Polkadot.js browser extension does not have functionality to make transactions directly. To make transactions, launch [Gear Idea](https://idea.gear-tech.io) on the browser. Before making any transactions, allow Gear Idea to access the account. The browser extension holds the account information. Choose which websites get to access this information.

#### Does Vara support hard wallets?

> Yes! Vara currently supports [Ledger](/docs/vara-network/account/ledger) and [Polkadot Vault](/docs/vara-network/account/polkadot-vault).
