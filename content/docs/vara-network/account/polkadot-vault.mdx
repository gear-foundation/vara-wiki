...
custom_title: Vara cold storage via Polkadot Vault (formerly Parity Signer)
browser_title: Polkadot Vault (formerly Parity Signer)
---
...
<div className="flex gap-2 items-center">
    <a href="https://itunes.apple.com/us/app/parity-signer/id1218174838" className='inline-flex'>
        <img src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg" alt="Download on the App Store" width={120} height={40} className="no-zoom m-0!" />
    </a>
    <a href="https://play.google.com/store/apps/details?id=io.parity.signer" className='inline-flex'>
        <img src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png" alt="Get it on Google Play" width={155} height={60} className="no-zoom m-0!" />
    </a>
</div>
...
<Callout type="warn" title="Air-Gap Security">
    To protect your accounts, the device with **Polkadot Vault must never go online.**

    Physically disable or turn off **Wi-Fi, Mobile Data, and Bluetooth**. While switching to **Airplane Mode** suffices in many cases, total isolation is the best practice to prevent online threats.
</Callout>
...
![add metadata](/images/docs/account/polkadot-vault-acc0.png)
...
![add metadata](/images/docs/account/polkadot-vault-phone.png)
...
<Callout type="note" title="Metadata Updates">
    Scanning QR codes with metadata can take some time. Ensure your **Polkadot Vault** is updated to the latest version of metadata after every network runtime upgrade.

    **Why?** We generate new QR codes for each upgrade. If the metadata is outdated, you will need to re-scan to maintain compatibility.
</Callout>
...
![img alt](/images/docs/account/subwallet-polkadot-vault.png)
...
![add metadata](/images/docs/account/polkadtot-via-qr.png)

2. In the Polkadot Vault app, select your account and network.

![add metadata](/images/docs/account/polkadot-vault-acc.png)
