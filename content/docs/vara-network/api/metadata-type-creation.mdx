---
title: Metadata & Type Creation
custom_title: Basics & Metadata / Type creation
---
...
More information about the basic types and methods of work can be found in the main documentation of Polkadot [here](https://polkadot.js.org/docs/developing/api/start/types.basics)
...
// Learn more https://polkadot.js.org/docs/developing/api/start/types.create#choosing-how-to-create
