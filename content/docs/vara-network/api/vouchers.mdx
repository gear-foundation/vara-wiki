...
An example of using vouchers is shown in the [Battleship](/docs/vara-network/examples/Gaming/Battleship) game. Users without tokens on their balance can make moves by sending messages to a program using a voucher.
