...
<Callout type="note" title="The Ping-Pong Pattern">
...
<Callout type="idea" title="Abstracted Infrastructure">
...
[**Vara ↔ Ethereum Bridge Technical Overview**](/docs/bridge/bridge_technical)
