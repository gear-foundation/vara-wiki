---
title: DEX
custom_title: Decentralized Exchange (DEX)
---
...
The source code, developed using the [Sails](/docs/developing/build/sails) framework, is available on [GitHub](https://github.com/gear-foundation/dapps/tree/master/contracts/tic-tac-toe). The exchange uses [Vara fungible tokens (VFT)](/docs/vara-network/examples/Standards/vft).
...
- **dns_info**: Optional information for domain name system ([dDNS](/docs/vara-network/examples/Infra/dein)) integration.
