...
<Callout type="warn" title="Deployment Order is Crucial">
    The system consists of two programs: `game` and `bot`. To deploy them successfully to the [Vara Network Testnet](https://idea.gear-tech.io/programs?node=wss%3A%2F%2Ftestnet.vara.network):
