...
![Tic-Tac-Toe](/images/docs/examples/tictactoe.png)
...
2. Upload the program to the [Vara Network Mainnet](https://idea.gear-tech.io/programs?node=wss%3A%2F%2Frpc.vara.network)
> Initiate the process by uploading the bot program, followed by the subsequent upload of the main program. Further details regarding the process of program uploading can be located within the [Getting Started](/docs/vara-network/quick-start#deploy-your-program-to-vara-mainnet) section.
