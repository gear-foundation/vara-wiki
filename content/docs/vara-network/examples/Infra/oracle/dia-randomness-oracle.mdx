...
The given dia-oracle implementation is an example of safe randomization. The source code, developed using the [Sails](/docs/developing/build/sails) framework, is available on [GitHub](https://github.com/gear-foundation/dapps/tree/master/contracts/oracle/randomness).
