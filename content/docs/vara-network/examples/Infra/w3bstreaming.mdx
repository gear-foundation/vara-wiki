...
2. 🏗️ **Upload the program** to the [Vara Network Mainnet](https://idea.gear-tech.io/programs?node=wss%3A%2F%2Frpc.vara.network): For further guidance on program uploading, please visit the [Getting Started](/docs/vara-network/quick-start#deploy-your-program-to-vara-mainnet) section.
