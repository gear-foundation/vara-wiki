...
Place the `extended_vnft.idl` file in the `api/sails` folder and run the Sails CLI:

```bash
cargo sails client-js src/api/sails/extended_vnft.idl src/api/sails/lib.ts
```
...
2.  Navigate to `Settings`:
    ![](/images/docs/examples/ssgQSvY.jpg)
    Locate `IPFS config`:
    ![](/images/docs/examples/nn82YO3.png)
