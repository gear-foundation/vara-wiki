---
title: DAO
custom_title: Decentralized Autonomous Organization
---
...
`approved_token_program_id` - the reference to the token contract ([VFT](/docs/vara-network/examples/Standards/vft)) that users use as pledge to get the share in the DAO.
