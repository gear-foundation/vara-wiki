...
![img alt](/images/docs/examples/goc.png)
...
2. In the network selector choose `Vara Network Mainnet` or `Development` (in this case, you should have a local node running)
...
<Callout type="note" title="Further Exploration">
    For a detailed technical description and implementation details, refer to:

    * [dApps Documentation Portal](https://dapps.gear.rs/game_of_chance)
    * [Source Code Section](/docs/vara-network/examples/archive/game-of-chance#source-code)
</Callout>
