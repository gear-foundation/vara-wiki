...
<Callout type="note" title="ERC-4907 Analogue">
    The **Vara Rentable Non-fungible Token (RNFT)** standard is the equivalent of Ethereum's **ERC-4907** on the Vara Network.
</Callout>
