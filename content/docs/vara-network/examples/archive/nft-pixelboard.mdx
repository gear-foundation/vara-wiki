...
<Callout type="note" title="Article Scope">
    This guide provides a **high-level overview** of the smart contract's purpose and logic.

    For deep technical details and implementation, please refer to:
    * [Detailed Technical Documentation](https://dapps.gear.rs/nft_pixelboard_io)
    * [Contract Source Code](/docs/vara-network/examples/archive/nft-pixelboard#source-code)
</Callout>
...
For more details about testing smart contracts written on Gear, refer to the [Program Testing](/docs/developing/build/testing) article.
