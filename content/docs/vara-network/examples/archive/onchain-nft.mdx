---
title: On-chain NFT
custom_title: On-chain gNFT assets
---

## Introduction

This example of an NFT smart contract shows a method where token assets are stored on the blockchain itself. To learn about a common implementation of gNFT smart contracts, refer to [vNFT-721](/docs/vara-network/examples/Standards/vnft).
...
For more details about testing smart contracts written on Gear, refer to this article: [Program Testing](/docs/developing/build/testing).
