...
<tr>
<td>Vara Network [Mainnet](https://idea.gear-tech.io/programs?node=wss%3A%2F%2Frpc.vara.network)</td>
<td>latest</td>
<td>
Ensure connection to Vara Network Mainnet - it is selected by default in https://idea.gear-tech.io. New wallets can claim a one-time grant of 100 VARA to cover deployment and first transactions.
</td>
</tr>
</tbody>
</table>
...
Refer to [Getting Started](/docs/vara-network/quick-start) for additional details.
