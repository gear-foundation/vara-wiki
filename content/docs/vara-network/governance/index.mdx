...
- **Track** - an Origin-specific pipeline that outlines the life cycle of proposals. Vara currently has 15 Tracks: Root, Whitelisted Caller, Staking Admin, Treasurer, Fellowship Admin, General Admin, Referendum Canceller, Referendum Killer, Small Tipper, Big Tipper, Small Spender, Medium Spender, Big Spender, Bridge Admin, and Bridge Pauser.
- **Fellowship** - a group of community members who have special voting rights within Vara and can add certain proposals to the Whitelisted Caller Track.
...
The Track outlines the lifecycle of the proposal. It is independent of other proposal tracks, which allows the network to tailor the dynamics of referenda based on their implied privilege level. In the example, a runtime upgrade (set_code call) has different implications for the ecosystem than a small treasury tip (a Small Tipper spend). Therefore different origins need to be established with separate predetermined turnouts, approvals, deposits, and minimum enactment periods.
...
|  ID |     Origin Track     |                                  Description                                  |                            Examples                            |
|:---:|:--------------------:|:-----------------------------------------------------------------------------:|:---------------------------------------------------------------:|
|  0  | Root                 | Highest privilege                                                             | Forced runtime changes, changing the ideal validator count      |
|  1  | Whitelisted Caller   | Root-level operations whitelisted by the Fellowship for a faster turnaround   | Runtime upgrades, adding validator slots, token burns           |
|  10 | Staking Admin        | Staking-related interventions                                                 | Cancelling pending slashes                                      |
|  11 | Treasurer            | Treasury management; spends of up to 50,000,000 VARA                          | Large treasury spends, rejecting treasury proposals             |
|  12 | Fellowship Admin     | Managing the Fellowship                                                       | Inducting, promoting or demoting Fellowship members             |
|  13 | General Admin        | For general on-chain decisions                                                | Managing identity registrars                                    |
|  20 | Referendum Canceller | For cancellation of a referendum. Decision Deposit is refunded                | Wrongly constructed referendum                                  |
|  21 | Referendum Killer    | For killing of bad/malicious referendum. Decision Deposit is slashed          | Malicious referendum                                            |
|  30 | Small Tipper         | Treasury tips of up to 1,000 VARA                                             | Small community rewards                                         |
|  31 | Big Tipper           | Treasury tips of up to 5,000 VARA                                             | Larger community rewards                                        |
|  32 | Small Spender        | Treasury spends of up to 50,000 VARA                                          | Funding small community initiatives                             |
|  33 | Medium Spender       | Treasury spends of up to 500,000 VARA                                         | Funding medium-sized community initiatives                      |
|  34 | Big Spender          | Treasury spends of up to 5,000,000 VARA                                       | Funding large ecosystem programs                                |
|  40 | Bridge Admin         | Administering the Vara ↔ Ethereum bridge                                      | Bridge governance operations                                    |
|  41 | Bridge Pauser        | Emergency-pausing the Vara ↔ Ethereum bridge                                  | Halting the bridge in an emergency                              |

The existence of distinct tracks enables proposers to customize the characteristics of their referenda according to their associated privilege levels. Referenda executed from more influential Origins will be subject to stricter safety measures, higher voting thresholds, and longer periods of consideration. The Root Origin is subject to the most stringent safeguards and highest thresholds. Origins that confer relatively limited power, such as the Small Tipper Origin, which only has the ability to spend up to 1,000 VARA from the treasury, will have correspondingly shorter consideration periods and lower approval thresholds.
...
Each Track defines its own capacity (the maximum number of referenda that can be in the Deciding Period at once), Decision Deposit, and set of periods. The values below are read directly from the Vara runtime (`api.consts.referenda.tracks`); the current values for each Track can always be inspected on [Subsquare](https://vara.subsquare.io/referenda).

|  ID |         Track        | Capacity | Decision Deposit (VARA) | Prepare Period | Decision Period | Confirm Period | Min Enactment Period |
|:---:|:--------------------:|:--------:|:-----------------------:|:--------------:|:---------------:|:--------------:|:--------------------:|
|  0  | Root                 |     1    |        15,000,000       |     2 hours    |     14 days     |      1 day     |         1 day        |
|  1  | Whitelisted Caller   |    100   |        1,500,000        |   30 minutes   |     14 days     |   10 minutes   |      10 minutes      |
|  10 | Staking Admin        |    10    |         750,000         |     2 hours    |     14 days     |     3 hours    |      10 minutes      |
|  11 | Treasurer            |    10    |         150,000         |     2 hours    |     14 days     |     3 hours    |         1 day        |
|  12 | Fellowship Admin     |    10    |         750,000         |     2 hours    |     14 days     |     3 hours    |      10 minutes      |
|  13 | General Admin        |    10    |         750,000         |     2 hours    |     14 days     |     3 hours    |      10 minutes      |
|  20 | Referendum Canceller |   1,000  |        1,500,000        |     2 hours    |      7 days     |     3 hours    |      10 minutes      |
|  21 | Referendum Killer    |   1,000  |        7,500,000        |     2 hours    |     14 days     |     3 hours    |      10 minutes      |
|  30 | Small Tipper         |    200   |           150           |    1 minute    |      7 days     |   10 minutes   |       1 minute       |
|  31 | Big Tipper           |    100   |          1,500          |   10 minutes   |      7 days     |     1 hour     |      10 minutes      |
|  32 | Small Spender        |    50    |          15,000         |     4 hours    |     14 days     |    12 hours    |         1 day        |
|  33 | Medium Spender       |    50    |          30,000         |     4 hours    |     14 days     |      1 day     |         1 day        |
|  34 | Big Spender          |    50    |          60,000         |     4 hours    |     14 days     |     2 days     |         1 day        |
|  40 | Bridge Admin         |     3    |        15,000,000       |     4 hours    |     14 days     |     6 hours    |        1 hour        |
|  41 | Bridge Pauser        |     5    |        3,750,000        |    3 minutes   |     12 hours    |     1 block    |        1 block       |

In addition, submitting any referendum requires a flat Submission Deposit of 1,500 VARA, and a referendum that never satisfies the conditions to enter the Deciding Period times out after 14 days.
...
In addition, there is a unique operation called **Cancelation** for intervening with a proposal already being voted on. The process will immediately reject an ongoing referendum regardless of its status. There is also a provision to ensure the deposit of the proposer is slashed if the proposal is malicious or spam — this is handled by the separate Referendum Killer Track.

Cancellation is a governance operation that must be voted upon by the network to be executed. The cancellation comes with its own Origin and Track (Referendum Canceller), which has a low lead-time and Approval/Support curves with slightly sharper reductions in their thresholds for passing, given that it is invoked with a sense of urgency. 
...
The Fellowship (through its members of rank III — Fellows — and above) authorizes an origin known as Whitelisted Caller to be executed with Root-level privileges and will only work with specific specified commands that the Fellowship has assigned. The Whitelist pallet verifies two things:
1. The origin is the Whitelisted Caller, i.e. that the referendum passed on this track
2. The Fellowship has indeed whitelisted the proposal.

Only if both conditions are satisfied the operation executes with Root-level privileges. This system enables the ability to have a new parallel Track (Whitelisted Caller Origin), whose parameters allow for a shorter voting turnaround.

In addition, an actively harmful proposal may be killed through the Referendum Killer Track. The referendum is immediately terminated regardless of its status and, unlike a cancellation, its Decision Deposit is slashed. This is useful for stopping malicious or spam proposals that have already entered the pipeline.
