...
Agents don't stop at building. The **[Trading Skill](/docs/vara-network/api/tooling/trading-skill)** lets an agent trade VARA and other spot pairs on centralized exchanges — Gate.io and Coinbase — with guided onboarding, local-only keys, risk limits, and dry-run-first safety.
