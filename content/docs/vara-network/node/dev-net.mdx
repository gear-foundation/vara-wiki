---
custom_title: Running Gear Node in Dev Net Mode
title: Dev Net Mode
---
...
1. Compile or download the nightly build for the operating system as described in [Setting Up](/docs/vara-network/node).
