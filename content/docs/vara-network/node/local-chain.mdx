...
custom_title: Building and Running a Local Vara Chain for Development and Testing
---
...
While Vara offers a ready-to-use public mainnet, local environments give you more control. You can modify chain parameters, test custom runtimes, or simulate multi-validator behavior without relying on any external infrastructure.
...
This guide walks you through building and running a local Vara blockchain network for development and testing purposes. While Vara Mainnet is open to everyone, local development offers complete control over chain parameters, consensus mechanisms, and runtime modifications.
...
- **Private Keys**: The mnemonic `bottom drive obey lake curtain smoke basket hold race lonely fit walk` is publicly known. Never use this for mainnet or any valuable assets.
