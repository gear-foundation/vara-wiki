...
There are no special hardware requirements except SSD for running a Vara node in dev mode. For nodes in the production network, see the requirements below.
