...
<Callout type="info" title="Infrastructure for Beginners">
...
<Callout type="warn" title="Service Configuration Details">
...
<Callout type="warn" title="Seed Phrase Security">
    **Save both seed phrases in a secure, offline place.**

    If you already have a seed phrase and want to use it, skip this step. You can manage your accounts via [Polkadot.\{js\} Apps](https://polkadot.js.org/apps/#/accounts) or the [Polkadot Extension](https://polkadot.js.org/extension/).
</Callout>
...
<Callout type="note" title="Minimum Self-Stake">
...
![setup validator](/images/docs/staking/setup-validator-1.png)

Set the `session key` and reward commission.

![setup validator](/images/docs/staking/setup-validator-2.png)
...
![setup validator](/images/docs/staking/setup-validator-3.png)
