...
browser_title: Vara Token Economy
custom_title: VARA Token Utility & Crypto Economics
---
...
A visualization of network tokenomics is available on the [Vara website](https://vara.network/network/tokenomics).

## VARA Utility & Token Distribution

**Total Token Supply: 10 Billions VARA**

![token distribution](/images/docs/tokenomics/chart-08.png)
...
![token distribution](/images/docs/tokenomics/chart-10.jpg)
...
1. **Staking rate:**
    ...
    <Callout type="info" title="Staking Rate Formula">
        The Staking Rate is calculated using these metrics:

        **Formula:**
        `Staking Rate = staked tokens / stakeable tokens`

        **Stakeable tokens:**
        `Total Supply (TTS) - Locked Team - Locked Investors - Inflation Pool`
    </Callout>
