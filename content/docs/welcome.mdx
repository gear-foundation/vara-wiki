...
- A robust [NPoS](/docs/staking) mechanism for network security and decentralization.
- [Governance](/docs/governance) by community members - token holders.
- A stable and upgradable network, facilitated by Substrate.
- A well-thought-out [token economy](/docs/tokenomics) that ensures the long-term sustainability of the network and benefits for its community.
...
1. Learn program development using the [developer documentation](/docs/build).
