...
- A robust [NPoS](./staking) mechanism for network security and decentralization.
- [Governance](./governance) by community members - token holders.
- A stable and upgradable network, facilitated by Substrate.
- A well-thought-out [token economy](./tokenomics) that ensures the long-term sustainability of the network and benefits for its community.
