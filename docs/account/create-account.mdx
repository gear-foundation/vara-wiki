...
There are several ways to generate a Substrate account described in this article, depending on whether you are using a desktop or a mobile device.
...
- To see your account in the Vara Network format, just go to https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Frpc.vara.network#/accounts.
...
> The Vara address prefix is 137. To see your account in the Vara Network format, just go to https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Frpc.vara.network#/accounts
