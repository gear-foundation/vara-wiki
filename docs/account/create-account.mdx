...
If you need to create a cold wallet for storing funds, then you should pay attention to [Polkadot Vault](parity-signer.mdx) (previously Parity Signer). In the future we will also add Ledger support.
