...
To sign messages/transactions, and transfer funds to and from Vara account you need to add Vara Network to the app.
...
2. Click + to import new account and choose `Attach external QR-signer account` option:
