...
:::note
The Vara Bridge between the Vara Testnet and Ethereum’s Holesky Testnet is now live for testing. 
Try it out [here](https://bridge.vara.network/).
:::
...
Read our detailed [technical description](/docs/bridge/bridge_technical).
