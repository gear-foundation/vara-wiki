...
:::note
The Vara Bridge is currently in public test mode between the Vara Testnet and Ethereum’s Hoodi Testnet. Stay updated on the mainnet launch by following [Vara Network on X](https://x.com/VaraNetwork) or visiting the [Vara Blog](https://vara.network/news).
:::
...
**From Ethereum → Vara**
Connect your Ethereum-compatible wallet (e.g., [MetaMask](https://metamask.io/), [Trust Wallet](https://trustwallet.com/) etc)
