...
[**EitherWay**](https://zk-bridge-stg.vara.network/) – the officially supported bridge interface designed for asset transfers between Vara and Ethereum. It currently supports transfers for the following assets:
