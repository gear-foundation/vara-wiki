...
**The up-to-date addresses for your network (testnet or mainnet) can always be found in the [Vara Bridge Developer Hub](https://wiki.vara.network/docs/bridge/developer_hub).**
:::
