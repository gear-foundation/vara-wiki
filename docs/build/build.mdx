...
Check [these articles](https://wiki.gear-tech.io/docs/developing-contracts/executable-functions) to start developing dApps on Gear Protocol. There you will find detailed information about Gear library, executable and state functions, data decoding/encoding, asynchronous programming, programs testing and more. 
