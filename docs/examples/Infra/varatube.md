...
- [Vara Fungible Token (VFT)](/docs/examples/Standards/vft/vft.md) contract determines user and service balances required to purchase a subscription and approves Subscription program to get funds from user's balance.
