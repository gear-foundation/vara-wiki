...
A frontend example showing how to use the `React Sails Hooks` with extended VFT program is available on [GitHub](https://github.com/gear-foundation/dapps/tree/master/frontend/apps/vft-extended).
