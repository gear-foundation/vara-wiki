...
To sign messages/transactions, and transfer funds to and from VARA account we need to add Vara Network into the app.

1. Open your Signer and select tab `scan`

2. Go to [Metadata Portal](https://metadata.vara-network.io/#/vara) and open chain specs tab
