...
An era lasts for 12 hours. Validators are split into two groups: active and inactive. The active validator group produces blocks and performs actions during an era. The composition of the active group can change between eras.
...
Era points incentivize validators to act in the network's best interest, maintain high uptime, and contribute to its overall security and reliability.
