...
```bash
curl -O https://get.gear.rs/gear-v0.2.1-x86_64-pc-windows-msvc.zip
```

or

**Windows x64**: [gear-v0.2.1-x86_64-pc-windows-msvc.zip](https://get.gear.rs/gear-v0.2.1-x86_64-pc-windows-msvc.zip)

Unzip the downloaded package then you can try to run the node:

```
❯ gear.exe --version
gear.exe 0.2.1-cfb433a4dcb
```
...
```bash
curl https://get.gear.rs/gear-v0.2.1-aarch64-apple-darwin.tar.xz | tar xJ
```

or

**macOS M1/M2**: [gear-v0.2.1-aarch64-apple-darwin.tar.xz](https://get.gear.rs/gear-v0.2.1-aarch64-apple-darwin.tar.xz)

You can try to run the node:

```
❯ ./gear --version
gear 0.2.1-cfb433a4dcb
```
...
```bash
curl https://get.gear.rs/gear-v0.2.1-x86_64-apple-darwin.tar.xz | tar xJ
```

or

**macOS Intel x64**: [gear-v0.2.1-x86_64-apple-darwin.tar.xz](https://get.gear.rs/gear-v0.2.1-x86_64-apple-darwin.tar.xz)
...
```bash
curl https://get.gear.rs/gear-v0.2.1-x86_64-unknown-linux-gnu.tar.xz | tar xJ
```

or

**Linux x64**: [gear-v0.2.1-x86_64-unknown-linux-gnu.tar.xz](https://get.gear.rs/gear-v0.2.1-x86_64-unknown-linux-gnu.tar.xz)
