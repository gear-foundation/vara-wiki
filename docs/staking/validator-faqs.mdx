...
1. __Validator Session Keys__: If you are running a validator node, please backup your session keys. These files are located in the `~/.local/share/gear/chains/vara_network/keystore` directory.

2. __Network Key__(optional): The network key uniquely identifies your node in the peer-to-peer network. It is located at `~/.local/share/gear/chains/vara_network/network/secret_ed25519`.
