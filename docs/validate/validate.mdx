...
:::info
How much VARA do I need to become Validator? Now the minimum amount of own stake to be selected equals **1 VARA**. Anyhow the minimum stake that is necessary to be elected as an active validator is dynamic and can change over time.
:::
