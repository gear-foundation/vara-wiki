...
export function HomepageHero() {
  return (
    <section className="relative flex items-center justify-center overflow-hidden dark:bg-card min-h-[min(calc(40svh),560px)]">
      <div className="absolute inset-0 z-0 dark:bg-[radial-gradient(42%_52%_at_50%_70%,color-mix(in_srgb,var(--primary)_20%,transparent)_0%,transparent_100%)] pointer-events-none" />
      <div className="container relative z-1 flex flex-col justify-center items-center py-8 md:py-10 text-foreground">
        ...
        <div className="mt-3 text-base text-muted-foreground md:text-[18px]/[24px] font-medium space-y-2 *:mb-0 text-balance">
          <p>
